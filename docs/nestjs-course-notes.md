...
### - Borded > Can research langgraph checkpointer
...
- Decorators:
  ...
  > [x] Revise: nestJs class decorator - reflect-metadata
  > [x] Method decorator: Combine Nestjs (Class Controller Deco - Method Get Deco)
  > [x] Parameter Decorator
  > [x] Revise: params and method decorator work together

  ***

  > [x] Revise Decorator
  > [x] Property decorator
  > [] Need to revise full flow again, see content below
  > [] DI - Related with deco
